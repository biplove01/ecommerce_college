...
const LoginPopUp = ({setShowLogin}) => {
    ...
    const [toast, setToast] = useState({
        show: false, type: 'success',        // 'success' or 'error'
        title: '', message: ''
    });
    ...
    const onSubmit = async (e) => {
        ...
        let userData = {
            name: name, email: email, password: password, phone: phone, shopName: shopName, address: address,
        }
    ...
    return (<div className='login-popup'>
        ...
        <form className="login-popup-container">
            ...
            <div className="login-popup-inputs">
                ...
                {currState === "Login" ? <></> : <div style={{marginTop: '8px'}}>
